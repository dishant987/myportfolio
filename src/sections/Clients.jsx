    ...
    <section className="c-space my-20">
      ...
      <div className="client-container">
        {clientReviews.map((item) => (
          <div key={`review-${item.id}`} className="client-review shadow-md shadow-black-500 duration-300 hover:shadow-[0_0_0px_6px_rgb(128,128,128),_0_0_7px_6px_rgb(192,192,192)]">
            <div >
